...
- Download: [GitHub — Meituan AutoML](https://github.com/Meituan-AutoML/INFORMS-TSL-2024-Challenge)
...
**1. Clone the repo**
```bash
git clone https://github.com/your-username/regime-aware-courier-dispatching.git
